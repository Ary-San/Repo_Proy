 ...
 *
 * Rejected orders are kept on purpose: they feed the admin panel and let a user
 * see why a purchase failed. The owner is the user, not the portfolio, because
 * a rejected order never touched the portfolio at all.
 *
...
public class TradeOrder {
    ...
    /** Idempotency key sent by the client: a double click fails with 409. */
    @NotNull
    ...
    /** Price taken from the quote cache at execution time. Null when rejected. */
